...
const staticZh = {
  skipLink: "跳到主要内容",
  wordmarkAria: "返回故事选择页",
  contextCare: "背景与说明",
  thresholdEyebrow: "开始之前",
  thresholdTitle: "这些文字能留到今天，离不开一代代人的传递。",
  thresholdDeck: "女书与湖南江永地区女性的生活密切相关。她们用女书写信、记歌，也在婚姻、离别和日常生活中彼此支持。接下来，你会看到四个根据史料创作的故事，并替故事中的女人写下一句话。",
  thresholdRoleLabel: "你会做什么",
  thresholdRole: "你不是在扮演历史人物，也不代表她们发言。你只是暂时接过一句话，把它写完，再送给故事中的收信人。",
  thresholdBoundaryLabel: "关于这些故事",
  thresholdBoundary: "四位人物和具体情节都是根据史料创作的虚构内容。页面会标明哪些内容有资料依据，哪些是为了叙事而补充的。",
  beginCarrying: "选择一个故事",
  skipIntroduction: "跳过介绍",
  careRouteAria: "体验流程",
  receive: "选择",
  receiveNote: "选择一个故事，读完来信",
  attend: "书写",
  attendNote: "按照字帖，一字一字描下来",
  carry: "送出",
  carryNote: "写完以后，把这句话送给收信人",
  return: "查证",
  returnNote: "最后查看史料，分清事实与虚构",
  homeEyebrow: "四位女人 · 四个虚构故事",
  homeTitle: "你想先替谁写一封信？",
  homeDeck: "选择一个故事，了解她为什么写下这句话，再沿着女书字帖把它写完。",
  homeChoicesAria: "从四个女书故事中选择一个",
  loadingContexts: "正在载入四个故事……",
  homeMethod: "四位人物均为虚构。开始书写前，页面会说明资料的核实情况；送出后，你可以查看完整的历史背景和资料来源。",
  readOpening: "重新阅读介绍",
  storyEyebrow: "一封等待送出的信",
  fictionalComposite: "根据史料创作的虚构人物",
  beforeWriting: "开始写之前",
  verifiedHere: "哪些内容有资料依据",
  sourcesReturnLater: "送出这句话后，你可以查看完整的历史背景和资料来源。",
  historicalGrounding: "历史背景",
  documentedImagined: "哪些是史实，哪些是虚构",
  returnStage: "04 · 查看资料",
  returnContext: "查看故事的历史背景",
  returnContextIntro: "这句话已经送到。现在看看哪些内容有史料依据，哪些是为这个故事创作的。",
  imaginedHere: "虚构内容",
  imaginedHereNote: "写信人、收信人、发生时间和具体情节都是根据相关史料创作的。",
  documentedHere: "有资料依据的内容",
  behindStory: "故事背景",
  readSources: "查看资料来源",
  photoArtefact: "照片或文物",
  audio: "声音",
  chooseAnother: "选择另一个故事",
  writingEyebrow: "写下她的话",
  brushGuidance: "使用触控笔时，笔压会影响墨色；使用鼠标或触屏时，移动速度会影响墨色。",
  writingSurface: "书写载体",
  surfaceNote: "选择一种书写材质。",
  surfaceAria: "选择书写载体",
  paper: "纸张",
  paperNote: "普通纸面",
  fan: "折扇",
  ...
  clothNote: "带纹理的织物",
  guideSize: "字帖大小",
  guideSizeAria: "选择字帖大小",
  comfort: "大字",
  comfortNote: "字形较大，比较容易描写",
  compact: "整行",
  compactNote: "一次显示整句话",
  lineGathers: "故事进度",
  stayMoment: "写字时，故事会继续展开。",
  keyboardAttention: "改用键盘操作",
  writingCanvasAria: "描写女书字形的画布",
  inkBrush: "墨笔",
  clearAgain: "清空笔迹，重新开始",
  releaseCloseAria: "回到书写",
  releaseEyebrow: "重新开始",
  releaseTitle: "要清空目前的笔迹吗？",
  releaseBoundary: "清空时的材质动画是本网站的视觉设计，不是对历史修改方式的复原。",
  releaseCancel: "回到书写",
  releaseConfirm: "清空笔迹，重新开始",
  partialTrace: "保留未完成的笔迹并继续",
  arrivalEyebrow: "这句话已经送到",
  whatCarried: "你写下的内容",
  evidenceBoundary: "资料说明",
  howRead: "这句话的含义和读音",
  handToHand: "这句话的传递过程",
  deliveryAria: "这句话从故事中的写信人出发，经过你的手，送到收信人那里",
  pauseKeeping: "保存之前，可以想一想",
  reflectionTitle: "写完这句话后，你有什么新的感受？",
  reflectionNotice: "书写的速度、停顿和材质，让你注意到了什么？",
  reflectionUnknown: "关于这位女人的生活，还有哪些事情是这个故事无法告诉你的？",
  reflectionPrivacy: "你写在这里的内容只会留在当前页面，不会出现在下载的图片中。",
  keepRecord: "保存这次书写",
  writeAgain: "再写一次",
  keptHand: "保存结果",
  savedCardAria: "你保存的书写卡片",
  meaningLabel: "这句话的意思",
  hanTranscription: "对应汉字",
  jiangyongReading: "江永方言读音",
  downloadImage: "下载图片",
  carryAnother: "再写一个故事",
  ...
  closeAria: "关闭",
  aboutTitle: "关于女书和本网站",
  aboutOne: "女书是一种与湖南江永地区关系密切的文字，过去主要在当地女性之间使用。她们用女书写信、记录歌谣，也用它表达生活中的感情和相互支持。",
  aboutTwo: "网站中的四位人物和具体情节都是虚构的，但故事涉及的书信、歌谣、生活处境和社会关系都有历史资料作为参考。每个故事后面都列出了资料来源。",
  aboutThree: "女书是一种记录语音的文字。同一个女书字形可能对应不同的汉语词语。第一组字帖已经和文献中的书信核对；另外三组是根据字典暂时匹配的字形，页面会明确标出。",
  aboutFour: "女书不是只存在于过去的文化遗产，今天仍有人学习、书写和研究它。体验这个网站时，请把自己看作访客，而不是这些女性的代言人。",
  aboutVisual: "四种书写载体参考了博物馆藏品中的笺纸纹样、装帧、针法、竖排格式和山水画笔法，但所有图像都是为本网站重新绘制的，并不是历史物件的复原。手帕参考来自旧海峡殖民地，只用于了解丝缎、抽纱边和刺绣的结构，不能用来证明江永当地也使用过相同纹样。",
  visualReferences: "视觉设计参考",
...
const dynamicCopy = {
  ...
  zh: {
    stageThreshold: "介绍", stageHome: "选择", stageEntering: "故事", stageWriting: "书写", stageAfter: "送达", stageArchive: "保存",
    loadError: "四个故事载入失败，请刷新页面后重试。",
    evidenceVerified: "人物和情节为虚构；原句和页面显示的女书字形已经过资料核对。",
    evidenceProvisional: "人物和情节为虚构；原句见于资料，页面显示的女书字形是根据字典暂时匹配的。",
    evidenceOpen: "人物和情节为虚构；由于没有经过核实的女书字形，这里只提供自由书写。",
    referenceCount: ({ count }) => `${count} 项参考资料`,
    fictionalComposite: "根据史料创作的虚构人物", carryWords: "进入故事 →", rights: ({ value }) => `使用权限：${value}`,
    withheld: "暂不显示", notRecorded: "没有记录", incompleteSource: "这项资料的来源信息不完整，因此不作为引用显示。", noSource: "这项内容没有附资料来源，不能把它当作历史证据。", notAttached: "未提供", invalidArtefact: "这项材料缺少来源、署名、使用权限、图注或替代文字，因此不显示。", noArtefact: "这个故事没有附上经过核实的照片或文物图片，也不会用重构图代替。", viewSource: "查看资料来源", unavailable: "暂时无法查看", artefactLoadError: "文物图片载入失败，页面不会用其他图片代替。", invalidAudio: "这项声音材料缺少来源、署名、使用权限、说明或文字稿，因此无法播放。", noAudio: "这个故事没有附带有明确来源的录音，因此不会播放声音。", audioSuffix: "音频不会自动播放，打开时默认为静音。", startsMuted: "默认静音。", sound: "声音", on: "开", off: "关", transcript: "阅读文字稿或声音说明", viewAudio: "查看声音资料来源", soundUnavailable: "声音暂时无法播放", audioLoadError: "声音材料载入失败。",
    formPending: "女书字形尚未确定", writeFor: ({ sender }) => `替${sender}写下这句话`, writingTitle: ({ sender, receiver }) => `把${sender}的话写给${receiver}`,
    guidedInstruction: ({ count }) => `请从上到下，依次描完 ${count} 个淡色字形。`, fanGuidedInstruction: ({ count }) => `请依次描完 ${count} 个淡色字形：每列从上到下，先写右列，再写左列。`, openInstruction: "你可以根据这个故事自由书写。",
    canvasVerified: ({ line }) => `用于描写女书句“${line}”的画布`, canvasProvisional: ({ line }) => `用于描写“${line}”暂定女书字形的画布`, canvasOpen: ({ title }) => `“${title}”的自由书写画布`,
    stayWith: ({ sender }) => `继续书写时，${sender}的故事也会展开。`, archiveDescription: ({ transcription, reading }) => `对应汉字：${transcription}。江永方言读音：${reading}。这是你的个人书写记录，不是历史文物。`,
    readingVerified: ({ count }) => `这 ${count} 个字形的江永方言读音已有资料记录。`, readingProvisional: ({ count }) => `这 ${count} 个暂定字形使用字典提供的江永方言读音。`, readingUnavailable: "这句话目前没有经过核对的读音。", readTranscription: "对应的汉字写在女书字形下方。", yourHand: "你的书写", deliveryDynamicAria: ({ sender, receiver }) => `${sender}的话经过你的书写，送到${receiver}那里`,
    sendOnward: "送出这句话", completeToSend: "写完整句话后才能送出", clearBeforeInput: "请先清空笔迹，再更换输入方式", returnDrawing: "改回手写描摹", useKeyboard: "改用键盘操作", keyboardModeNote: "每按一次键，系统会记录一次停顿，不会模拟手写笔迹。更换输入方式前，请先清空当前记录。", drawingModeNote: "如果手写描摹不方便，你也可以每看完一个字形就按一次键。系统只记录按键和停顿，不会生成模拟笔迹。",
    keyboardTrace: "键盘操作记录", partialTraceLabel: "未完成的手写记录", handwritingTrace: "手写记录", traceCaption: ({ trace }) => `这是你在查看解释前留下的${trace}`, traceAria: ({ trace }) => `你在书写阶段留下的${trace}`, savedTraceAria: ({ trace }) => `你保存的${trace}`, traceFooter: ({ trace }) => `${trace} · 个人书写记录，不是历史文物`,
    allForms: ({ count }) => `${count} 个字形都已完成，可以送出这句话了。`, lineReady: "可以送出了", formStatus: ({ index, count, reading }) => `这是第 ${index} 个字，共 ${count} 个${reading ? `，读音是 ${reading}` : ""}。看完后，请按下面的按钮。`, attendForm: ({ index }) => `查看第 ${index} 个字形`,
    keyboardProgressReady: ({ total }) => `${total}/${total} · 已完成，可以送出了。`, keyboardProgress: ({ index, total }) => `${index}/${total} · 准备好后继续下一个字。`,
    pageOpen: "书写区已经准备好。", beginFirstTop: "请从最上面的第一个字开始。", clearBeforeGuide: "请先清空笔迹，再调整字帖大小", lineReadyFor: ({ sender, receiver }) => `${sender}写给${receiver}的这句话已经完成。`, sendItOnward: "送出这句话", startHere: "从这里开始", next: "下一个字", progressReady: ({ total }) => `${total}/${total} · 已完成，可以送出了。`, progressContinue: ({ index, total }) => `${index}/${total} · 请继续往下写。`, progressNextColumn: ({ index, total }) => `${index}/${total} · 请从左列最上面继续。`, returnToForm: ({ index }) => `请回到第 ${index} 个淡色字形的位置。`, traceMore: ({ index }) => `第 ${index} 个字还没描完整，请继续沿着淡色字形写。`, revisionKept: ({ index }) => `补写的笔迹已经保留，请继续写第 ${index} 个字。`, finishCurrentFirst: ({ index }) => `请先写完第 ${index} 个字，再写后面的字。`, continueForm: ({ index }) => `请继续写下面的第 ${index} 个字。`, continueNextColumn: ({ index }) => `请到左列最上面，继续写第 ${index} 个字。`,
    pressurePace: "笔压 · 速度", touchPressure: "触屏压力", stylusPressure: "触控笔压力", paceSensing: "根据移动速度变化", stylusPace: "触控笔 · 速度", touchPace: "触屏 · 速度", pressureDeepens: "笔压越大，墨色越深。", slowerFuller: "写得越慢，笔画越粗。",
    beginBeforeSend: "请先写第一个字。", incompleteLine: ({ index }) => `这句话还没写完。请继续写第 ${index} 个字，也可以选择保留未完成的笔迹并继续。`, guideRecedes: "淡色字帖会慢慢变淡，稍后进入送达页面。", partialRecedes: "淡色字帖会慢慢变淡；保存时会注明这是一份未完成的手写记录。",
    releasePaper: "纸边会出现烧灼效果，原来的笔迹会随灰烬散去，随后出现一张空白纸。", releaseFan: "折扇会一页页合上，再重新展开为空白扇面。", releaseCloth: "笔迹会像织线一样逐渐散开，随后留下空白织物。", releaseInProgress: "正在清空笔迹。", releaseComplete: "书写区已经清空，请从第一个字重新开始。",
    surfacePaper: "纸张", surfaceFan: "折扇", surfaceCloth: "织物", meaningLabel: "这句话的意思", hanTranscription: "对应汉字", jiangyongReading: "江永方言读音", archiveKeyboard: "键盘操作记录 · 个人记录", archivePartial: "未完成的手写记录 · 个人记录", archiveHandwriting: "手写记录 · 个人记录", archiveDocumented: "虚构故事 · 原句和字形已经核对", archiveProvisional: "虚构故事 · 字形为暂时匹配", archiveOpen: "虚构故事 · 自由书写"
  }
};
